...
RaylibRectangle texShapesRec = {0.0f, 0.0f, 1.0f, 1.0f };    // Texture source rectangle used on shapes drawing
...
void SetShapesTexture(Texture2D texture, RaylibRectangle source)
{
    texShapes = texture;
    texShapesRec = source;
}
...
{
    DrawRectanglePro((RaylibRectangle){position.x, position.y, size.x, size.y }, (Vector2){0.0f, 0.0f }, 0.0f, color);
}
...
{
    DrawRectangleGradientEx((RaylibRectangle){(float)posX, (float)posY, (float)width, (float)height }, color1, color2, color2, color1);
}
...
{
    DrawRectangleGradientEx((RaylibRectangle){(float)posX, (float)posY, (float)width, (float)height }, color1, color1, color2, color2);
}

// Draw a gradient-filled rectangle
// NOTE: Colors refer to corners, starting at top-lef corner and counter-clockwise
void DrawRectangleGradientEx(RaylibRectangle rec, Color col1, Color col2, Color col3, Color col4)
{
    rlSetTexture(texShapes.id);
...
void DrawRectangleLinesEx(RaylibRectangle rec, float lineThick, Color color)
{
...
void DrawRectangleRounded(RaylibRectangle rec, float roundness, int segments, Color color)
{
...
void DrawRectangleRoundedLines(RaylibRectangle rec, float roundness, int segments, float lineThick, Color color)
{
    ...
    if (roundness <= 0.0f)
    {
        DrawRectangleLinesEx((RaylibRectangle){rec.x - lineThick, rec.y - lineThick, rec.width + 2 * lineThick, rec.height + 2 * lineThick}, lineThick, color);
        return;
    }
...
bool CheckCollisionRecs(RaylibRectangle rec1, RaylibRectangle rec2)
{
    bool collision = false;
...
bool CheckCollisionCircleRec(Vector2 center, float radius, RaylibRectangle rec)
{
    bool collision = false;
...
RaylibRectangle GetCollisionRec(RaylibRectangle rec1, RaylibRectangle rec2)
{
    RaylibRectangle rec = {0, 0, 0, 0 };
